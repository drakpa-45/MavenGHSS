 ...
 */
function _baseURL() {
    return cdbGlobal.baseURL() + "/GHSS/architects";
}
...
function validatepersonalSection(){
    ...
    if($('#serviceSectorType').val()==""){
        $('#serviceSectorType_err').html('Please select service type');
        $('#serviceSectorType').focus();
        retutype=false;
    }
    if($('#trade').val()==""){
        $('#trade_err').html('Please select trade');
        $('#trade').focus();
        retutype=false;
    }
    return retutype;
...
function updateReject(){
    if(validateReject()){
        var url= '/GHSS/admin_architect/emptylayout/updatereject';
...
function verifyApplication(){
    var url= '/GHSS/admin_architect/emptylayout/verifyArchitectRegistration';
    var options = {target:'#content_main_div',url:url,type:'GET', data: $('#architectverificationForm').serialize()};
    $("#architectverificationForm").ajaxSubmit(options);
}
function approveApplication(type){
    url= '/GHSS/admin_architect/emptylayout/approveArchitectRegistration?servicefor='+type;
    var options = {target:'#content_main_div',url:url,type:'GET', data: $('#architectverificationForm').serialize()};
    $("#architectverificationForm").ajaxSubmit(options);
}
...
function SubmitApplicationDetials(){
    var url='/GHSS/public_access/emptylayout/saveArchitect';
...
function viewAttachment(uuid,type,path,name){
    ...
    var url= '/GHSS/public_access/emptylayout/donwloadFiles?uuid='+uuid+'&type='+type;
