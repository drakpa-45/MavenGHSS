                                ...
                                <ul class="dropdown-menu dropdown-menu-arrow"
                                    ...
                                    <li class="has-dropdown" class="dropdown-item" style="position: relative;"><a href="#"
                                        ...
                                        <ul class="dropdown-sub-menu" style="text-align:left;">
                                            <li><a href="<c:url value="/public_view/staffdtls"><c:param name="type" value="management"/></c:url>" class="dropdown-item">Management</a></li>
                                            <li><a href="<c:url value="/public_view/staffdtls"><c:param name="type" value="dzoFaculty"/></c:url>" class="dropdown-item">Dzongkha Faculty</a></li>
                                            <li><a href="<c:url value="/public_view/staffdtls"><c:param name="type" value="engFaculty"/></c:url>" class="dropdown-item">English Faculty</a></li>
                                            <li><a href="<c:url value="/public_view/staffdtls"><c:param name="type" value="humanitiesFaculty"/></c:url>" class="dropdown-item">Humanities Faculty</a></li>
                                            <li><a href="<c:url value="/public_view/staffdtls"><c:param name="type" value="comFaculty"/></c:url>" class="dropdown-item">Commerece Faculty</a></li>
                                            <li><a href="<c:url value="/public_view/staffdtls"><c:param name="type" value="sciFaculty"/></c:url>" class="dropdown-item">Science Faculty</a></li>
                                            <li><a href="<c:url value="/public_view/staffdtls"><c:param name="type" value="mathFaculty"/></c:url>" class="dropdown-item">Mathematics Faculty</a></li>
                                        </ul>
                                    </li>
